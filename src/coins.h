...
public:
    ...
    unsigned int GetSerializeSize() const
    {
        ...
        // version
        nSize += ::GetSerializeSize(VARINT((unsigned int) nVersion));
        // size of header code
        ...
        // height
        nSize += ::GetSerializeSize(VARINT((unsigned int) nHeight));
        return nSize;
    }
    ...
    void Serialize(Stream& s) const
    {
        ...
        // version
        ::Serialize(s, VARINT((unsigned int) nVersion));
        // header code
        ...
        // coinbase height
        ::Serialize(s, VARINT((unsigned int) nHeight));
    }
    ...
    void Unserialize(Stream& s)
    {
        ...
        // version
        ::Unserialize(s, VARINT((unsigned int) nVersion));
        // header code
...
//        }
        // coinbase height
        ::Unserialize(s, VARINT((unsigned int) nHeight));
        Cleanup();
    }
...
public:
    ...
    /** 
     * Amount of giant coming in to a transaction
