...
#ifndef GIANT_ZGICWALLET_H
#define GIANT_ZGICWALLET_H
...
public:
    CzGICWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZGIC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZGIC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
