...
bool IsSporkActive(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_SMART_CONTRACTS_ACTIVATION) r = SPORK_17_SMART_CONTRACTS_ACTIVATION_DEFULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_SMART_CONTRACTS_ACTIVATION") return SPORK_17_SMART_CONTRACTS_ACTIVATION;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_SMART_CONTRACTS_ACTIVATION) return "SPORK_17_SMART_CONTRACTS_ACTIVATION";
