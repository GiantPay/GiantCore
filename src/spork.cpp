...
bool IsSporkActive(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_STAKE_MIN_AMOUNT) r = SPORK_17_STAKE_MIN_AMOUNT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_STAKE_MIN_AMOUNT") return SPORK_17_STAKE_MIN_AMOUNT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_STAKE_MIN_AMOUNT) return "SPORK_17_STAKE_MIN_AMOUNT";
