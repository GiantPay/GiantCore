...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GIANT features */
        {"giant", "masternode", &masternode, true, true, false},
        {"giant", "masternodelist", &masternodelist, true, true, false},
        {"giant", "mnbudget", &mnbudget, true, true, false},
        {"giant", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"giant", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"giant", "mnsync", &mnsync, true, true, false},
        {"giant", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"giant", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use giantd, or the -server option to giant-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
